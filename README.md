...
You have to design & build the backend for the application and the ability for the users to register, add rooms, find rooms etc.
...
https://github.com/azaylamba/roomster 
